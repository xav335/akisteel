...
INSERT INTO `contact` VALUES (33,'fránck','l\'anglé','','','','franck_langle@hotmail.fr',NULL,NULL,1,0,0),(34,'Gregorio','Gonzalez','','','','fjavi.gonzalez@gmail.com',NULL,NULL,1,0,0),(35,'Adrien','Maziere','','','','a.maziere@hotmail.fr',NULL,NULL,1,0,0),(36,'Kevin','Pestre-sorge ','','','','kevin.ps@orange.fr',NULL,NULL,1,0,0),(37,'Arnaud','Marchand','22  LDIT Rochereau','33230','Abzac','contact@gidonet.fr','0640177658',NULL,0,0,1),(38,'Sébastien','Préjean','','','','prejeansebastien@gmail.com',NULL,NULL,0,0,0),(39,'Manuela','Dutour','','','','dutour.manu@gmail.com',NULL,NULL,0,0,0),(40,'SEB','CHALMEY','99 ROUTE D\'ANGLUMEAU','33450','IZON','contact@akidoor.fr','06 58 53 63 16',NULL,0,0,1),(41,'Xavier','Gonzalez','','','','xavier@gonzalez.pm',NULL,NULL,1,0,0),(42,'sophie','roland','','','','atelier.eurosieges@gmail.com',NULL,NULL,0,0,0),(48,'Marie line ','Siré ','N1 le candelon ','33920','Générac ','bazatolemaryline@gmail.com','0689735541','Je voudrais un devis pour la pose et fournitures d\'un portail roulant dimension 8 m de long sur 1,50 de haut.pouvez vous me contacter s\'il vous plaît merci',1,0,1),(49,'Amandine','Ferlicot','3 rue Bourly','33700','Mérignac','amandine.risser24@gmail.com','0686329267','Bonjour,\r\nje voudrais connaitre vos tarifs pour la fourniture et pose du main courante d\'escalier en acier d\'une longueur de 4m15\r\nen vous remerciant\r\nMe Ferlicot ',1,0,1),(50,'marie','parahy','6 Allée REBSOMEN','33120','ARCACHON','mlparahy@gmail.com','0622390465','Bonjour, j\'ai le projet de changer mes deux portails; La municipalité dArcachon impose des normes contraignantes, Il faut donc faire du sur mesure;\r\n\r\nMerci de votre retour, \r\n\r\nmarie ',0,0,1),(51,'Maurice','Belleville','17 ave du général leclerc','33200','Bordeaux','mauricebelleville5@gmail.com','0663179770','Projet de construction d\'une marquise  Tel pour rv si intéressé. Merci par avance',0,0,1),(52,'frederic','valladon','20 rue georges barres cidex 399','33083','bordeaux','bages@vulcain-metal.fr','0684521018','Bonjour, je suis à la recherche de sous-traitant en pose pour deux affaires sur la région bordelaise, si cela est susceptible de vous intéresser veuillez me contacter.\r\n\r\ncordialement\r\n\r\nfrederic valladon \r\n\r\nsociété vulcain TEL:06.84.52.10.18 ',0,0,1),(53,'LUCIE','GOUSSE','40 RUE STE MONIQUE ','33000','BORDEAUX','g.lucie05@gmail.com','0674690231','Bonjour \r\nje rechecher des tringles à rideaux en fer forgé, pouvez me dire si vous faites cela , je vous remercie\r\ncdt',1,0,1),(54,'Rémy ','Bignon','10 lieu dit Pierrebrune ','33620','Laruscade ','remybi2025@gmail.com','0648667849','Bignon Rémy\r\n10 lieudit pierrebrune\r\n33620 laruscade\r\n\r\n0648667849\r\n\r\nMonsieur,\r\nJe me permets de vous contacter parce que  je cherche un apprentissage dans la métallerie ou dans la ferronnerie. Je suis actuellement élève en seconde professionnelle au Lycée Philippe Cousteau à St André de Cubzac ou je prépare un CAP Conducteur d\'Installation et de Production.  \r\nJe me permets de vous contacter car je souhaite m\'orienter vers un apprentissage en métallerie car je suis depuis toujours intéressé par le travail manuel et artisanal, et cela serai pour moi une véritable chance de travailler dans le domaine de la métallerie.\r\nJ\'espère que vous pourrez répondre favorablement à ma demande d\'apprentissage.\r\nJe suis à votre disposition afin de vous envoyer mon CV et ma lettre de motivation.\r\nCordialement,\r\nRemy Bignon.',1,0,1),(55,'OLIVIER','MARAZANO','SAS VERRESPACE','16430','CHAMPNIERS','verrespace.om@orange.fr','0545958883','Bonjour,\r\nNous sommes une entreprise spécialisée dans la menuiserie aluminium et la petite serrurerie.\r\nNous avons un chantier comportant un escalier industriel hélicoïdal galvanisé et un escalier droit avec paliers, également galvanisé.\r\nPouvez-vous nous établir un devis, en fourniture seule, pour ce chantier situé en Charente.\r\n\r\nMerci d\'avance, cordialement.',0,0,1),(56,'Ramona Stefania','Munteanu','20 Avenue de Paris','33240','Cubzac les Ponts ','ramonastefania.munteanu@gmail.com','33640648396','Bonjour \r\n\r\nVous pouvez s’il vous plaît me donner votre adresse mail pour vous envoyer les éléments pour un devis garde corps ?\r\n\r\nJe vous remercie !',1,0,1),(57,'jean','aingot','2 bis rue des saules','33500','libourne','jsmain@orange.fr','0685911111','bonjour, besoin d\'un devis pour un escalier en acier sur mesure dans une maison en cours de rénovation. 2/4 tournants, hauteur 2m925m, tremie 90cm, longueur au sol environ 3m90. Combien faut il compter avec livraison, pose, et dans un délai de combien environ?\r\nMerci d\'avance.',0,0,1),(58,'serge','laugier','10 allee des vignes','33170','gradignan','laugier1@free.fr','0782753668','Portillon pour espace de 93 cm de hauteur et 146 cm de large\r\nalum ou pvc blanc',1,0,1),(59,'Laurence','Jestin','Lieu-Dit Touvent','24750','Champcevinel','laurence.jestin@orange.fr','0618103907','Bonjour,\r\nLa gloriette en bois de 2,35m de hauteur qui soutient vigne et rosier de mon jardin sur une dalle carrée de 2,95m de côté est en voie de décomposition ... avancée. Je souhaite la remplacer par une structure en métal aux lignes simples.\r\nAfin de vous éviter un déplacement, pouvez- vous me donner une idée du coût de cet ouvrage et je vous recontacterai si mon budget me le permet. Cordialement.',0,0,1),(60,'Yves','D\'ORSO','SCI CARLAUTHI, 48 av. Gustave Eiffel','33440','ST VINCENT DE PAUL','yvesdorso@wanadoo.fr','0139040540   ou    06 02 48 25 64','portail refait et motorisé par Lionel PERISSE en 2016 en panne. URGENCE\r\nVous deviez passer ce jour ; MERCI DE VOTRE RETOUR\r\nSur place : EMILIO: 06 76 57 61 57\r\nDans l\' attente, meilleures salutations\r\nYves D\' ORSO',1,0,1),(61,'Quentin','KAUFFMANN','Rescoll - 8, allée Geoffroy Saint Hilaire','33615','Pessac','quentin.kauffmann@rescoll.fr','0547746900','Bonjour,\r\n\r\nNous somme à la recherche de deux types de grilles carrées soudées en acier inoxydable (faites sur mesure) :\r\n\r\n- Une grille d\'espacement 20 +/- 2 mm, avec des fils de diamètre 0,8 +/- 0,1 mm\r\n\r\n- Une grille d\'espacement 9 +/- 1 mm, avec des fils de diamètre 1,0 +/- 0,1 mm\r\n\r\nPS : si vous contactez le numéro de téléphone indiqué ici, vous tomberez sur l\'accueil de Rescoll : demandez Nicolas VANEL, mon responsable.',0,0,1),(62,'Xavier ','PASTY','27 rue Marceau','33110','LE BOUSCAT','xavierpasty@gmail.com','0616498494','Bonjour,\r\n\r\nSuite aux travaux réalisés par vos soins dans notre maison, nous aurions souhaiter à nouveau faire appel à vos services pour la création d\'une baie vitrée. \r\n\r\nNous sommes à votre écoute pour vous recevoir pour la réalisation du devis.\r\n\r\nCordialement ',1,0,1),(63,'evelyne','bezy','21 CHEMIN DU GOUBERT','33450','SAINT LOUBES','bezy.eve@orange.fr','0618161939','Bonjour,\r\n\r\nJe vous ai laissé un message téléphonique pour la fabrication d\'un escalier métallique extérieur sur mesure pour une maison sur st loubès,\r\n\r\nmerci, \r\nMme BEZY 0618161939',0,0,1),(64,'GUILLAUME','BOEDEC','2 PLACE DU PUITS, LIEU DIT BERTIN','33570','MONTAGNE','guillaume.boedec.pro@gmail.com','0674432998','Bonjour,\r\n\r\nJe souhaite savoir si vous pouvez réaliser des limons 3 marches en Acier.\r\nJ\'aurais besoin de 4 limons.\r\n\r\nIl m\'est possible de vous transmettre photos + plan.\r\n\r\nCordialement',0,0,1),(65,'jocelyne','DESVALLEES','Allée des pasteurines N° 42','33200','bordeaux','jdesvallees@yahoo.com','0663836998','Mon ami Pierre LOUIS (restaurant la bonne pâte) m\'a remis vos coordonnées pour un travail : J\'ai un portail et portlllon sur lequel je voudrais fixer une feuille d\'alu pour protéger des regards indiscrets. Avez vous l\'occasion de passer dans mon secteur ou voulez vous que je vous adresse une photo et les dimensions afin que vous jugiez...\r\nRemerciements',0,0,1),(66,'zammit','patricia','4 allée de canterane','33450','SAINT SULPICE ET CAMEYRAC','lhgirafe@hotmail.fr','0621570234','Bonjour,\r\nJ\' habite Sulpice et Cameyrac et je souhaite transformer mon garage existant en intégrant des bandeaux alu  blanc de 40 cm de haut + des sous faces de toit.\r\nMerci de me contacter\r\nCdt\r\n\r\n',0,0,1);
...
-- Dump completed on 2019-01-26  0:19:26
